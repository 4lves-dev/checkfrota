const CACHE = "checkfrota-v187";
const ASSETS = ["./", "./index.html", "./gestao.html?v=187", "./lider.html?v=187", "./instalar-gestao.html?v=187", "./instalar-lider.html?v=187", "./aprovacao.html?v=187", "./styles.css?v=187", "./supabase-config.js?v=187", "./onesignal.js?v=187", "./app.js?v=187", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=187");
  }));
});
