...
const CACHE = "checkfrota-v202";
const ASSETS = ["./", "./index.html", "./gestao.html?v=202", "./lider.html?v=202", "./instalar-gestao.html?v=202", "./instalar-lider.html?v=202", "./aprovacao.html?v=202", "./styles.css?v=202", "./supabase-config.js?v=202", "./onesignal.js?v=202", "./app.js?v=202", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=202");
  }));
});
