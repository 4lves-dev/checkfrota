...
const CACHE = "checkfrota-v214";
const ASSETS = ["./", "./index.html", "./gestao.html?v=214", "./lider.html?v=214", "./instalar-gestao.html?v=214", "./instalar-lider.html?v=214", "./aprovacao.html?v=214", "./styles.css?v=214", "./supabase-config.js?v=214", "./onesignal.js?v=214", "./app.js?v=214", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=214");
  }));
});
