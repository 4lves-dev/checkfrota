...
const CACHE = "checkfrota-v215";
const ASSETS = ["./", "./index.html", "./gestao.html?v=215", "./lider.html?v=215", "./instalar-gestao.html?v=215", "./instalar-lider.html?v=215", "./aprovacao.html?v=215", "./styles.css?v=215", "./supabase-config.js?v=215", "./onesignal.js?v=215", "./app.js?v=215", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=215");
  }));
});
