...
const CACHE = "checkfrota-v205";
const ASSETS = ["./", "./index.html", "./gestao.html?v=205", "./lider.html?v=205", "./instalar-gestao.html?v=205", "./instalar-lider.html?v=205", "./aprovacao.html?v=205", "./styles.css?v=205", "./supabase-config.js?v=205", "./onesignal.js?v=205", "./app.js?v=205", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=205");
  }));
});
