...
const CACHE = "checkfrota-v212";
const ASSETS = ["./", "./index.html", "./gestao.html?v=212", "./lider.html?v=212", "./instalar-gestao.html?v=212", "./instalar-lider.html?v=212", "./aprovacao.html?v=212", "./styles.css?v=212", "./supabase-config.js?v=212", "./onesignal.js?v=212", "./app.js?v=212", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=212");
  }));
});
