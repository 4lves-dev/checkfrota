...
const CACHE = "checkfrota-v211";
const ASSETS = ["./", "./index.html", "./gestao.html?v=211", "./lider.html?v=211", "./instalar-gestao.html?v=211", "./instalar-lider.html?v=211", "./aprovacao.html?v=211", "./styles.css?v=211", "./supabase-config.js?v=211", "./onesignal.js?v=211", "./app.js?v=211", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=211");
  }));
});
