...
const CACHE = "checkfrota-v213";
const ASSETS = ["./", "./index.html", "./gestao.html?v=213", "./lider.html?v=213", "./instalar-gestao.html?v=213", "./instalar-lider.html?v=213", "./aprovacao.html?v=213", "./styles.css?v=213", "./supabase-config.js?v=213", "./onesignal.js?v=213", "./app.js?v=213", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=213");
  }));
});
