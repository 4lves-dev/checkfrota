...
const CACHE = "checkfrota-v199";
const ASSETS = ["./", "./index.html", "./gestao.html?v=199", "./lider.html?v=199", "./instalar-gestao.html?v=199", "./instalar-lider.html?v=199", "./aprovacao.html?v=199", "./styles.css?v=199", "./supabase-config.js?v=199", "./onesignal.js?v=199", "./app.js?v=199", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=199");
  }));
});
