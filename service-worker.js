const CACHE = "checkfrota-v188";
const ASSETS = ["./", "./index.html", "./gestao.html?v=188", "./lider.html?v=188", "./instalar-gestao.html?v=188", "./instalar-lider.html?v=188", "./aprovacao.html?v=188", "./styles.css?v=188", "./supabase-config.js?v=188", "./onesignal.js?v=188", "./app.js?v=188", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=188");
  }));
});
