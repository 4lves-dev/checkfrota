...
const CACHE = "checkfrota-v204";
const ASSETS = ["./", "./index.html", "./gestao.html?v=204", "./lider.html?v=204", "./instalar-gestao.html?v=204", "./instalar-lider.html?v=204", "./aprovacao.html?v=204", "./styles.css?v=204", "./supabase-config.js?v=204", "./onesignal.js?v=204", "./app.js?v=204", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=204");
  }));
});
