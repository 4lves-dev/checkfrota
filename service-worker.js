...
const CACHE = "checkfrota-v217";
const ASSETS = ["./", "./index.html", "./gestao.html?v=217", "./lider.html?v=217", "./instalar-gestao.html?v=217", "./instalar-lider.html?v=217", "./aprovacao.html?v=217", "./styles.css?v=217", "./supabase-config.js?v=217", "./onesignal.js?v=217", "./app.js?v=217", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=217");
  }));
});
