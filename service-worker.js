...
const CACHE = "checkfrota-v203";
const ASSETS = ["./", "./index.html", "./gestao.html?v=203", "./lider.html?v=203", "./instalar-gestao.html?v=203", "./instalar-lider.html?v=203", "./aprovacao.html?v=203", "./styles.css?v=203", "./supabase-config.js?v=203", "./onesignal.js?v=203", "./app.js?v=203", "./manifest.webmanifest", "./gestao-manifest.webmanifest", "./lider-manifest.webmanifest", "./icons/icon.svg", "./version.json"];
...
self.addEventListener("notificationclick", (event) => {
  ...
  event.waitUntil(clients.matchAll({ type: "window", includeUncontrolled: true }).then((windows) => {
    ...
    return open ? open.focus() : clients.openWindow("./lider.html?v=203");
  }));
});
